                            ...
                            <div class="nav-wrapper">
                                ...
                                <div aria-hidden="false" tabindex="-1" class="nav-container ">
                                    ...
                                    <ul class="nav bz-navbar-nav navbar-right">
                                        ...
                                        <li class="m-item"><a href="publisher_list.php" class="m-link"><span class="glyphicon glyphicon-paperclip"></span>&nbsp; Publisher</a></li>
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <table class="table">
                                            <?php foreach($row as $key => $value){
                                              if($key == "book_descr" || $key == "book_image" || $key == "publisherid" || $key == "book_title" || $key == "seller_id" ){
                                                continue;
                                              }
                                              switch($key){
                                                case "book_isbn":
