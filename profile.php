<?php
    ...
    $conn = db_connect();
    $result = getUserByUsername($conn, $username);
                        ...
                        <div class="left-container">
                            <table class="table" style="margin-top: 20px">
                                <?php while($row = mysqli_fetch_assoc($result)){ ?>
                                    ...
                                    <a href="edit_profile.php?username=<?php echo $row['username']; ?>" class="mtr-button btn-white">
                                            Edit Profile
                                        </a>
                                    <a href="signout.php" class="mtr-button btn-white">
                                            Signout
                                        </a>
                                        <?php } ?>
